```{r include_packages_2, include = FALSE, echo=F}
...
```{r reedlogo, fig.cap="Reed logo", echo=F}
...
```{r delaysboxplot, warnings=FALSE, messages=FALSE, fig.cap="Mean Delays by Airline", fig.width=6, echo=F}
...
```{r subd, results="asis", echo=FALSE, fig.cap="Subdiv. graph", out.extra="scale=0.75", echo=F}
...
```{r subd2, results="asis", echo=FALSE, out.extra="angle=180, scale=1.1", fig.cap="A Larger Figure, Flipped Upside Down", echo=F}
include_graphics("figure/subdivision.pdf")
```
